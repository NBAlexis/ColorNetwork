...
class CNAPIPRIVATE CCStringData
{
private:
...
public:
    ...
    CNAPI friend CCString operator+(const CCString& string1, const CCString& string2);
    CNAPI friend CCString operator+(const CCString& string, TCHAR ch);
    CNAPI friend CCString operator+(TCHAR ch, const CCString& string);
    CNAPI friend CCString operator+(const CCString& string, const TCHAR* lpsz);
