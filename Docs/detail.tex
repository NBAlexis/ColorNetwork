\documentclass[a4paper,twoside,openany,UTF8]{ctexbook}
\usepackage{geometry}
...
\input "BasicTopics/NRGandDMRG.tex"

\chapter{\label{sec:Decompose}Decompose Methods}

\section{\label{sec:MatrixDecompose}Matrix Decompose}

\input "Decompose/Matrix/LanczosSVD.tex"
